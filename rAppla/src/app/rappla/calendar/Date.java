...
public class Date extends Property implements Constants, Comparable<Date>
{
	...
	public static int[] monthDays = { 31, 28, 31, 30, 31, 30, 31, 31, 30, 31,
			30, 31 };

	public static int[] leapMonthDays = { 31, 29, 31, 30, 31, 30, 31, 31, 30,
			31, 30, 31 };
	...
	{
		if (dateOnly)
			return String.format(Locale.ENGLISH, "%02d.%02d.%04d", day, month,
					year);
		else
			return String.format(Locale.ENGLISH,
					"%02d.%02d.%04d %02d:%02d:%02d", day, month, year, hour,
					minute, second);
	}
