...
public class StringUtils implements Constants
{
	 ...
	 * than 75 characters, a ParseException will be generated if parseMode is
	 * set to PARSE_STRICT. Additionally, non-ASCII characters will be converted
	 * from their quoted-printable format. If parseMode is not set to
	 * PARSE_STRICT, escaped commas "\," will be unescaped. (Mozilla Sunbird
	 * does this escaping which is not part of the RFC 2445 specification.)
	 * 
	 * @param line
	 ...
	 */
	static public int parseStatus(String icalStr) throws BogusDataException,
			ParseException
	{
